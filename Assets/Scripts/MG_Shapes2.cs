...
public class MG_Shapes2 : MonoBehaviour
{
    ...
    [Header("Preguntas")]
    [SerializeField] private PreguntaFormas2[] preguntas;
    ...
    private void MostrarPreguntaActual()
    {
        ...
        PreguntaFormas2 preguntaActual = preguntas[indicePreguntaActual];
